<div>
    ...
    <div class="bg-gray-100">
        <section class="container p-4 md:p-container-padding ">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                ...
                <div class="flex flex-col items-center pr-4 md:items-start border-main-color md:border-r-2 border-r-0">
                    ...
                    <p class="text-secondary-text-color text-center md:text-left">
                        Career 180 is one of the top rising Ed-Tech startups in Egypt, aiming to be a one stop shop for
                        all
                        youth from their career development journey till getting hired and meeting the need for
                        professional
                ...
                {{-- Our Mission Column --}}
                <div
                    class="flex flex-col items-center md:items-start border-main-color md:pr-4 pr-0 md:border-r-2 border-r-0">
                    <div class="bg-secondary-color rounded-lg p-4 mb-4">
                    ...
                    <p class="text-secondary-text-color text-center md:text-left">
                        We are a bunch of enthusiastic individuals who established a comprehensive and interactive
                        online
                        career knowledge network. Through Career 180 we creatively connect you with industry experts,
                        career
                ...
                <div class="flex flex-col items-center md:items-start">
                    ...
                    <p class="text-secondary-text-color text-center md:text-left">
                        To be the 1st choice to all the ambitious youth, to enhance their delicate abilities to a level
                        they
    ...
    <section class="container p-4 md:p-container-padding bg-white">
        ...
        <div class="mt-10 bg-cover bg-center bg-no-repeat p-10"
            style="background-image: url({{ asset('assets/invest-section.png') }})">
            <iframe class="w-full md:h-[500px] h-[300px] rounded-lg" width="560" height="315"
                src="https://www.youtube.com/embed/obCH5N0mYIA?si=7UhnAWHUalNyltK9" title="YouTube video player"
                frameborder="0"
